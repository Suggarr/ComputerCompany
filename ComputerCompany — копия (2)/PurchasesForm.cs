...
namespace ComputerCompany
{
    public partial class PurchasesForm : Form
    {
        ...
        private void textBoxPurchaseReason_Validating(object sender, CancelEventArgs e)
        {
            if (string.IsNullOrWhiteSpace(textBoxPurchaseReason.Text))
            {
                MessageBox.Show("Введите причину закупки.", "Ошибка валидации", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                e.Cancel = true;
            }
        }
    }
